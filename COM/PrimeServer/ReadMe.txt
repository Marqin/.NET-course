========================================================================
    ACTIVE TEMPLATE LIBRARY : PrimeServer Project Overview
========================================================================

AppWizard has created this PrimeServer project for you to use as the starting point for
...
PrimeServer.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (PrimeServer.h)
        GUID definitions                                (PrimeServer_i.c)
        A type library                                  (PrimeServer.tlb)
        Marshaling code                                 (PrimeServer_p.c and dlldata.c)

PrimeServer.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in PrimeServer.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named PrimeServer.pch and a precompiled types file named StdAfx.obj.
...
PrimeServerps.vcxproj
	...
	dlldata.c, PrimeServer_i.c and PrimeServer_p.c which are required
	to build the proxy/stub DLL.

PrimeServerps.vcxproj.filters
